...
function PrivateRoute({ children, role, loginTo = '/login' }) {
  ...
  if (!user) return <Navigate to={loginTo} />;
  if (role && user.role !== role) return <Navigate to={roleHome[user.role] || '/student'} />;
  return children;
}
